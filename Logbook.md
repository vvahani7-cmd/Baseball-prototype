...
public class PitchData
{
    ...
    public float cp1Horizontal;
    public float cp1Depth;
...
A functional cubic Bezier-based pitch system is implemented.

Pitch trajectories are fully data-driven and tunable.

Ball motion uses constant-speed traversal via arc-length parameterization.

Trajectories and control points are visualized using Gizmos.

The foundation is ready for hit detection and gameplay logic.